...
public final class Task implements Model {
  ...
  private Task(String id, String title, String body, Temporal.DateTime date, TaskStateEnum state) {
    this.id = id;
    this.title = title;
    this.body = body;
    this.date = date;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String title, String body, Temporal.DateTime date, TaskStateEnum state) {
      super.id(id);
      super.title(title)
        .body(body)
        .date(date)
