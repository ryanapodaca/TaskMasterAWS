...
public class AdMobActivity extends AppCompatActivity {
    private static String TAG = "AdMobActivity";
    ...
    private void setUpBannerAd() {
        myBannerAd = findViewById(R.id.adMobActivityBannerAdView);
    ...
    private void setUpInterstitialAd() {
            ...
            public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                ...
                myInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                    ...
                    public void onAdImpression() {
                        ...
                        // Called when an impression is recorded for an ad,impression means that its rendered long enough to be seen.
                    ...
                    public void onAdShowedFullScreenContent() {
                        ...
                        // Called when ad is shown in full
        ...
        Button interstitialAdButton = findViewById(R.id.adMobActivityinterstitialAdButton);
        interstitialAdButton.setOnClickListener(v -> {
            if(myInterstitialAd != null) {
                myInterstitialAd.show(AdMobActivity.this);
            } else {
    ...
    private void setUpRewardedAd() {
        ...
        Button myRewardedAdButton = findViewById(R.id.adMobActivityRewardedAdButton);
